                ...
                return (
                  <div key={r.id} className="min-w-0">
                    ...
                    >
                      ...
                      <div className="relative overflow-hidden h-[80px] md:h-[160px]">
                        {hasImage ? (
                          <img
                            src={r.image_url!}
                            alt={r.title}
                        ...
                        <button
                          ...
                          className={cn(
                            "absolute top-1 right-1 w-6 h-6 rounded-full flex items-center justify-center transition-all shadow-sm",
